...
interface MetricsRepository {
    ...
    fun getDailyConsumption(): Flow<Result<DailyConsumptionResponse>>
    fun getAcuLimits(): Flow<Result<AcuLimitsResponse>>
    suspend fun updateAcuLimits(newLimit: Double): Result<AcuLimitsResponse>
    ...
    fun getSearchMetrics(): Flow<Result<SearchMetricsResponse>>
